...
├── app/
│   ├── __init__.py
│   ├── main.py                 # Точка входа (FastAPI application)
│   ├── api/
│   │   ├── __init__.py
│   │   └── routes/
│   │       ├── auth.py         # Аутентификация (register, login)
│   │       ├── rooms.py        # Управление комнатами
│   │       ├── voting.py       # Голосование и результаты
│   │       └── ws.py           # WebSocket маршруты
│   ├── core/
...
│   │   ├── room.py             # Комнаты
│   │   ├── room_participant.py # Участники комнат
│   │   ├── task.py             # Задачи
│   │   ├── deck_preset.py      # Пресеты колод
│   │   ├── invitation_link.py  # Ссылки-приглашения
│   │   ├── voting_round.py     # Раунды голосования
│   │   ├── vote.py             # Голоса
│   │   ├── voting_result.py    # Результаты
│   │   ├── base.py             # Базовая модель
│   │   └── enums.py            # Перечисления
│   ├── repositories/           # Слой доступа к данным
│   │   ├── auth_repository.py
│   │   ├── room_repository.py
│   │   └── voting_repository.py
